        ...
        <div className="h-72 border-b-2 border-slate-100 flex gap-4 justify-start ml-28 items-center">
            ...
            <div className="flex flex-col gap-8 justify-center">
                ...
                <p className="text-2xl font-bold ml-2">${book.price}</p>
                    <button className="h-12 w-32 text-lg font-semibold shadow-sm bg-green-700 text-stone-200 rounded-lg">Add to Cart</button>
                    <button className="text-green-800 ml-2">Want to read</button>
                </div>
