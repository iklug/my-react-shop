...
const Homepage = ({handleSelection}) => {
    return (
    <div className="">
        <div>
            ...
            <Link to='/browse'><button className="h-16 w-48 mt-10 ml-16 text-xl shadow-md bg-green-700 text-stone-100 rounded-md " onClick={handleSelection}>Start Exploring</button></Link>
        </div>
